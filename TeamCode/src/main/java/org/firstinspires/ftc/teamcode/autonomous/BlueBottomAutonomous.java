...
@Autonomous(name = "BlueBottomAutonomous")
public class BlueBottomAutonomous extends LinearOpMode{
    ...
    public void runOpMode(){
        ...
        Trajectory traj1 = drive.trajectoryBuilder(new Pose2d(-35.625, 70, Math.toRadians(270)))
                .forward(30)
                .build();
